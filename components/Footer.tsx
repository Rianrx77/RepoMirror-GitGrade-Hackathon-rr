...
export default function Footer() {
  ...
  return (
    <footer className="mt-20 py-12 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex items-center gap-6 pt-2">
            ...
            <a
              href="https://www.linkedin.com/in/rian-renju-96b1142b3/"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 hover:scale-110"
            >
